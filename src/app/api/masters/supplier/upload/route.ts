...
import { mapTradeReceivableExcelRow } from '@/lib/module-excel-maps';
import {
...
import { provisionTradeReceivableWorkspacesForAllEligibleUsers } from '@/lib/tp-workspace-provision';
...
/** POST /api/masters/supplier/upload — same TR listing Excel/CSV as Trade Receivables (masters + TR rows). */
export async function POST(request: NextRequest) {
  ...
  const trProvisioned = await provisionTradeReceivableWorkspacesForAllEligibleUsers(user.userId);
